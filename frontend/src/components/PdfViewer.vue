<template>
  <div class="pdf-viewer">
    <div class="pdf-toolbar">
      ...
      <button class="tb-btn" :disabled="page >= totalPages" @click="page++">
        &gt;
      </button>
      <button class="tb-btn" @click="scale = Math.min(3, scale + 0.2)">
        +
      </button>
      <button class="tb-btn" @click="scale = Math.max(0.3, scale - 0.2)">
        -
      </button>
    </div>
